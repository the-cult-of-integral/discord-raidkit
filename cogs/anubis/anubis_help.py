    ...
    async def help(self, ctx):
        ...
        if not author.guild_permissions.manage_messages \
            ...
            if author.guild_permissions.manage_messages:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}clear [1-1000]",
            ...
            if author.guild_permissions.kick_members:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}kick <member> [reason]",
            ...
            if author.guild_permissions.ban_members:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}ban <member> [reason]",
            ...
            if author.guild_permissions.administrator:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}unban <member>",
            ...
            if author.guild_permissions.mute_members:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}mute <member> [reason]",
                    value="Mutes a member on the server.",
                    inline=False)
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}unmute <member>",
        ...
        if not author.guild_permissions.mute_members \
            ...
            if author.guild_permissions.administrator:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}db_add_member <member>",
                    value="Adds a member to my raider database.",
                    inline=False)
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}db_del_member <member>",
            ...
            if author.guild_permissions.mute_members:
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}lock",
                    value="Locks down current text channel during a raid.",
                    inline=False)
                embed.add_field(
                    name=f"{self.config_data.get('prefix')}unlock",
