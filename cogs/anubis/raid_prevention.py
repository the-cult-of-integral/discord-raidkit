...
class RaidPrevention(commands.Cog, name='RaidPrevention module'):
    ...
    @commands.command(name="db_add_member")
    ...
    @commands.command(name="db_del_member")
    @commands.has_guild_permissions(administrator=True)
    ...
    async def lock(self, ctx, channel: discord.TextChannel = None):
        ...
        if ctx.guild.default_role not in channel.overwrites:
            ...
            await ctx.send(embed=embed)
        elif channel.overwrites[ctx.guild.default_role].send_messages or \
            channel.overwrites[ctx.guild.default_role].send_messages is None:
    ...
    async def unlock(self, ctx, channel: discord.TextChannel = None):
        ...
        if ctx.guild.default_role not in channel.overwrites:
            ...
            await ctx.send(embed=embed)
        elif channel.overwrites[ctx.guild.default_role].send_messages is None or \
            channel.overwrites[ctx.guild.default_role].send_messages == False:
            overwrites = channel.overwrites[ctx.guild.default_role]
